...
export function SortableRow({ row, index, token, isContinuation, parentBucket, bucketTotalTime, bucketOptions, isDraggingList, onUpdate, onDelete, onAddBelow, onAddSongToBucket }) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  // Use parent bucket for continuation rows
